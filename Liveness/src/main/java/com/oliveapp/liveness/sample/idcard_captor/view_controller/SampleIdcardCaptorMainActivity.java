    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable ex) {
                com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.e(TAG, "Uncaught exception", ex);
            }
        });
...
//            actionBar.hide();
        ...
        setContentView(getResources().getIdentifier("oliveapp_activity_sample_idcard_captor", "layout", mPackageName));

        mVerticalTextView = (VerticalTextView) findViewById(getResources().getIdentifier("oliveapp_face_hintTextView", "id", mPackageName));
        mTakePictureButton = (ImageButton) findViewById(getResources().getIdentifier("oliveapp_face_takePictureButton", "id", mPackageName));
        mIdcardShadeView = (ImageView) findViewById(getResources().getIdentifier("oliveapp_face_idcardSkeletonImageView", "id", mPackageName));
        mPreview = findViewById(getResources().getIdentifier("oliveapp_face_cameraPreviewView", "id", mPackageName));
        mTakePictureButton.setOnClickListener(mTakePhotoButtonClickListener);
        mScanLineImageView = (ImageView) findViewById(getResources().getIdentifier("oliveapp_face_scan_line", "id", mPackageName));
    ...
    private void initCamera() {
        ...
        mPhotoModule.init(this, findViewById(getResources().getIdentifier("oliveapp_face_cameraPreviewView", "id", mPackageName))); // 参考layout XML文件里定义的cameraPreviewView对象
    ...
    private View.OnClickListener mTakePhotoButtonClickListener = new View.OnClickListener() {
        ...
        com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.i(TAG, "用户按了拍摄按钮");
    ...
    public void onPictureTaken(byte[] data, CameraManager.CameraProxy camera) {
        if (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.LOG_ON) {
            com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.i(TAG, "[BEGIN] onPictureTaken...");
        }
        ...
        if (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.LOG_ON) {
            com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.i(TAG, "original size " + bitmap.getWidth() + "x" + bitmap.getHeight());
        }
        ...
        int imageHeight;
        int imageWidth;
        if (bitmap.getWidth() > com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.ID_CARD_UPLOAD_IMAGE_WIDTH + 5) {
            imageHeight = (int) (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.ID_CARD_UPLOAD_IMAGE_WIDTH / (float) bitmap.getWidth() * bitmap.getHeight());
            imageWidth = com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.ID_CARD_UPLOAD_IMAGE_WIDTH;
            if (1 == (imageHeight & 1)) {
                imageHeight -= 1;
            }
            if (1 == (imageWidth & 1)) {
        ...
        if (imageHeight != bitmap.getHeight() || imageWidth != bitmap.getWidth()) {
            ...
            if (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.LOG_ON) {
                com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.d(TAG, "get sub image, width: " + bitmap.getWidth() + " imageHeight: " + bitmap.getHeight());
            }
        }

        if (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.LOG_ON) {
            com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.i(TAG, "final image size, width: " + bitmap.getWidth() + " height: " + bitmap.getHeight());
        }

        byte[] imageContent = ImageUtil.convertBitmapToJPEGByteArray(bitmap, com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.USER_REGISTRATION_UPLOAD_IMAGE_QUALITY);
        ...
        if (com.oliveapp.face.livenessdetectorsdk.livenessdetector.configs.ApplicationParameters.LOG_ON) {
            com.oliveapp.face.livenessdetectorsdk.utilities.utils.LogUtil.d(TAG, "[END] onPictureTaken done");
        }
    }
