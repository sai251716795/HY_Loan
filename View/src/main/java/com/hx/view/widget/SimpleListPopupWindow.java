...
public class SimpleListPopupWindow extends PopupWindow{
    ...
    public SimpleListPopupWindow(Activity context, View view, String text, String title, OnClickListener onClickListener){
    ...
    public SimpleListPopupWindow(Activity context, List<String> list,float size, String title, AdapterView.OnItemClickListener itemClick){
        this.context = context;
        this.mData = list;
        this.size = size;
...
//        backgroundAlpha(1f);
    ...
    class PopupAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            final String detail = mData.get(position);
            hodler.textView.setText(detail);
            return convertView;
        }
        private void setTextView( ViewHodler viewHolder){
            viewHolder.textView.setTextSize(size);
        }
