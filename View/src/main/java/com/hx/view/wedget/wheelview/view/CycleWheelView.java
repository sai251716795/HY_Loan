...
public class CycleWheelView extends ListView {
	...
	private static final int COLOR_DIVIDER_DEFALUT = Color
			.parseColor("#FFFFFF"); //747474
	private static final int HEIGHT_DIVIDER_DEFAULT = 2;
	private static final int COLOR_SOLID_DEFAULT = Color.parseColor("#FFFFFF");//3e4043
	private static final int COLOR_SOLID_SELET_DEFAULT = Color
			.parseColor("#FFFFFF");//323335
	...
	private int default_text_size = 20, select_text_size = 25;
	...
	private void resetItems(int firstPosition, int position, int offset) {
		for (int i = position - offset - 1; i < position + offset + 1; i++) {
			...
			if (position == i) {
				...
				labelTv.setTextSize(select_text_size);
				...
				labelTv.setTextSize(default_text_size);
			}
		}
	}
	...
	public void setSelectorTextSize(int textSize){
		this.select_text_size = textSize;
	}
